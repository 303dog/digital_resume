...
Program.create(title: "Digital Resume" ,program_lang:"Ruby/JS" , focus: "Frontend" , repo: "https://github.com/303dog/digital_resume.git" , project_date: "2020-11-15", demo: "https://youtu.be/CwAEbc0NYtwcd", about: "This is the program. An accessible version of my portfolio with links and ability to comment on my work.")
